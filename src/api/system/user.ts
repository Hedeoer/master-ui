import type { ApiResult, ExistParam, PageParam, PageResult, UpdateStateParam } from '~/types/global'
import type {
  ChangePasswordParam, ResetPwdParam, SysUser,
  SysUserSaveParam, SysUserUpdateParam,
